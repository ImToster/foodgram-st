    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lovers', models.ManyToManyField(related_name='favorite_recipes', through='food.FavoriteRecipe', to=settings.AUTH_USER_MODEL)),
                ('shoppers', models.ManyToManyField(related_name='purchased_recipes', through='food.Purchase', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='purchase',
